...
const textToBinary = (text: string): { binaryData: number[], originalLength: number } => {
...
const splitIntoBlocks = (binaryData: number[], blockSize: number = 12): number[][] => {
    const blocks = [];
